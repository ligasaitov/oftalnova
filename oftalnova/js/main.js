...
function init() {
	...
	myPlacemark = new ymaps.Placemark([55.67885812457311,37.63375173544312],{
		id:'2'
	},
	{
	// Опции.
...
// ------------------------------------------------
	...
	myContPlacemark = new ymaps.Placemark([55.67885812457311,37.63375173544312],{
		id:'2'
	},
	{
	// Опции.
...
var nagatinskaya = new ymaps.multiRouter.MultiRoute({
	...
	[55.67988944426887,37.63651709293745],
...
[55.679815665538605,37.63766305278789],
[55.67885812457311,37.63375173544312],
],
params: {
// Тип маршрута: на общественном транспорте.
...
myContMap.geoObjects.add(myContPlacemark);

myContMap.behaviors.disable('scrollZoom');

myContMap.controls.add(
	'zoomControl', {size: 'large'}
	);
}
...
if ($('.specialists__slider_sliders').length > 0) {
	$('.specialists__slider_sliders').slick({
		...
		autoplaySpeed: 5000,
		//asNavFor:'',
		appendArrows: $('.specialists__slider_sliders-arrows'),
		nextArrow: '<button type="button" class="slick-next"><img class="svg" src="img/icons/right-arrow.svg" alt="" /></button>',
		prevArrow: '<button type="button" class="slick-prev"><img class="svg" src="img/icons/right-arrow.svg" alt="" /></button>',
		responsive: [{
			breakpoint: 1170.01,
...
if ($('.gallery__slider_sliders').length > 0) {
	$('.gallery__slider_sliders').slick({
		...
		autoplaySpeed: 5000,
		//asNavFor:'',
		appendArrows: $('.gallery__slider_sliders-arrows'),
		nextArrow: '<button type="button" class="slick-next"><img class="svg" src="img/icons/right-arrow.svg" alt="" /></button>',
		prevArrow: '<button type="button" class="slick-prev"><img class="svg" src="img/icons/right-arrow.svg" alt="" /></button>',
		responsive: [{
			breakpoint: 1170.01,
...
if ($('.equipment__slider_sliders').length > 0) {
	$('.equipment__slider_sliders').slick({
		...
		autoplaySpeed: 5000,
		//asNavFor:'',
		appendArrows: $('.equipment__slider_sliders-arrows'),
		nextArrow: '<button type="button" class="slick-next"><img class="svg" src="img/icons/right-arrow.svg" alt="" /></button>',
		prevArrow: '<button type="button" class="slick-prev"><img class="svg" src="img/icons/right-arrow.svg" alt="" /></button>',
		responsive: [{
			breakpoint: 1170.01,
...
if ($('.video__slider_sliders').length > 0) {
	$('.video__slider_sliders').slick({
		...
		adaptiveHeight: true,
		//asNavFor:'',
		appendArrows: $('.video__slider_sliders-arrows'),
		nextArrow: '<button type="button" class="slick-next"><img class="svg" src="img/icons/right-arrow.svg" alt="" /></button>',
		prevArrow: '<button type="button" class="slick-prev"><img class="svg" src="img/icons/right-arrow.svg" alt="" /></button>',
		responsive: [{
			breakpoint: 1170.01,
...
if($('.bottomToTop-right-bottom .ellips-bg:nth-child(1)').length>0){
	$('.bottomToTop-right-bottom .ellips-bg:nth-child(1)').append(elS + '1' + elC + '1' + elE);
}
if($('.bottomToTop-right-bottom .ellips-bg:nth-child(3)').length>0){
	$('.bottomToTop-right-bottom .ellips-bg:nth-child(3)').append(elS + '2' + elC + '2' + elE);
}
if($('.linear_bg .ellips-bg:nth-child(1)').length>0){
	$('.linear_bg .ellips-bg:nth-child(1)').append(elS + '3' + elC + '3' + elE);
}
if($('.linear_bg .ellips-bg:nth-child(3)').length>0){
	$('.linear_bg .ellips-bg:nth-child(3)').append(elS + '4' + elC + '4' + elE);
}
if($('.linear_bg .ellips-bg:nth-child(5)').length>0){
...
$('.filters .select-options__value').click(function () {
	$('.grid-item').removeClass('hide');
	$('.all-reviews').addClass('hide').removeClass('all-reviews');
});
